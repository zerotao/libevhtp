...
struct evhtp {
    ...
    uint8_t                 disable_100_cont; /**< if set, evhtp will not respond to Expect: 100-continue */
...
struct evhtp_req {
    ...
    uint8_t           keepalive : 1, /**< set to 1 if the conn is keep-alive */
                      finished  : 1, /**< set to 1 if the req is fully processed */
                      chunked   : 1, /**< set to 1 if the req is chunked */
                      error     : 1,
                      websock   : 1,
                      pad       : 3;
...
struct evhtp_kv {
    ...
    uint8_t k_heaped; /**< set to 1 if the key can be free()'d */
    uint8_t v_heaped; /**< set to 1 if the val can be free()'d */
